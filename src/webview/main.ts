...
const vscode = window.snaptexVsCodeApi || acquireVsCodeApi();
    ...
    const TIKZ_BATCH_RENDER_TIMEOUT_MS = 65000;
    const TIKZ_RENDER_DEBOUNCE_MS = 200;
    ...
    const TIKZ_SCRIPT_SELECTOR = `${TIKZ_PENDING_SCRIPT_SELECTOR}, script[type="${TIKZ_ACTIVE_SCRIPT_TYPE}"]`;
    ...
    const BLOCK_VIRTUALIZATION_CLEANUP_DELAY_MS = 700;
    ...
    class BlockVirtualizationController {

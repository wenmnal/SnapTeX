...
This draft links several numbered objects in one place: the sample mean identity in Equation~\eqref{eq:sample-mean}, the uploaded image in Figure~\ref{fig:frog}, the widget summary in Table~\ref{tab:widgets}, the streaming update sketch in Algorithm~\ref{alg:snap-update}, and the rendering pipeline in Figure~\ref{fig:tikz-pipeline}.
